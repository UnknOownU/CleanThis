 ...
 */
final class Version20240320231251 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE operation (id INT AUTO_INCREMENT NOT NULL, customer_id INT NOT NULL, salarie_id INT DEFAULT NULL, type VARCHAR(100) NOT NULL, name VARCHAR(100) NOT NULL, price INT NOT NULL, description LONGTEXT NOT NULL, status VARCHAR(255) NOT NULL, zipcode_ope VARCHAR(10) NOT NULL, city_ope VARCHAR(255) NOT NULL, street_ope VARCHAR(255) NOT NULL, finished_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', rdv_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', attachment VARCHAR(255) NOT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_1981A66D9395C3F3 (customer_id), INDEX IDX_1981A66D5859934A (salarie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) DEFAULT NULL, name VARCHAR(50) NOT NULL, firstname VARCHAR(50) NOT NULL, zipcode VARCHAR(10) DEFAULT NULL, city VARCHAR(50) DEFAULT NULL, street VARCHAR(100) DEFAULT NULL, phone VARCHAR(25) DEFAULT NULL, id_google VARCHAR(255) DEFAULT NULL, reset_token VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
